...
module.exports = class JestTimeLogger {
	...
	run() {
		...
		console.table({
			"Formatted time (hh:mm:ss.ms)": formattedTime,
			"Test runs logged": numberOfTests,
			"Average test time": averageTestTime,
			"Longest test seconds": `${longestTest.toFixed(2)} seconds`,
		});
